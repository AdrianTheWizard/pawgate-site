...
let users = [];
let files = [
  {name:'PawGate for Windows',  type:'WIN',  cat:'desktop', url:'https://github.com/AdrianTheWizard/pawgate-app/releases/download/v1.2.2/PawGate.Setup.1.2.2.exe', meta:'Windows 10/11 · 64-bit · v1.2.2 · Oppdaterer seg selv automatisk', status:'available'},
