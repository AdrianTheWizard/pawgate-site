...
let users = [];
let files = [
  {name:'PawGate for Windows',  type:'WIN',  cat:'desktop', url:'https://github.com/AdrianTheWizard/pawgate-app/releases/download/v1.0.6/PawGate-Setup-1.0.6.exe', meta:'Windows 10/11 · 64-bit · v1.0.6 · Oppdaterer seg selv automatisk', status:'available'},
